...
/**
 * Primary data keys used to segment metrics.<p>
 *
 * Generated from
...
{
    /**
     * The names of browsers used by visitors to your website. For example, "Internet Explorer" or
     * "Firefox." The version of the browser is not returned in this field.
     */
    ...
    /**
     * The cities of site visitors, derived from IP addresses. The city field falls in a hierarchy
     * of geographical groupings used in Analytics, which proceeds in the following order:
     * continent, sub-continent, country, region, sub-region, and city.
     */
     ...
     * www.googlestore.com to reach your site, this string appears as one of the hostnames used to
     * reach your site. However, if other visitors also come to your site via googlestore.com or
     * via an IP redirect from a search engine result (66.102.9.104), those values will also be
     * present in this field.
     */
    public static final Dimension HOSTNAME = new Dimension("ga:hostname");

    /**
     * A two digit hour of the day ranging from 00-23. (Google Analytics does not track visitor
     * time more precisely than hours.) Note: Combining this dimension with ga:adContent is not
     * currently supported.
     */
    public static final Dimension HOUR = new Dimension("ga:hour");

    /**
     * Whether the visitor has Java support enabled on their browser. The possible values are Yes
     * or No.
     */
    public static final Dimension JAVA_ENABLED = new Dimension("ga:javaEnabled");

    /**
     * This field uses the language as provided by the HTTP Request for the browser to determine
     * the primary languages used by visitors. Values are given as an ISO-639 code (e.g. en-gb for
     * British English).
     */
    ...
    /**
     * The name of service providers used to reach your site. For example, if most visitors to
     * your site come via the major service providers for cable internet, you will see the names
     * of those cable service providers in this element.
     */
    ...
    /**
     * The operating system used by your visitors. For example, Windows, Linux, Macintosh, iPhone,
     * iPod.
     */
    public static final Dimension OPERATING_SYSTEM = new Dimension("ga:operatingSystem");

    /**
     * The version of the operating system used by your visitors, such as XP for Windows or PPC
     * for Macintosh.
     */
    public static final Dimension OPERATING_SYSTEM_VERSION = new Dimension(
     ...
     * Values include 4-bit, 8-bit, 24-bit, or undefined-bit.
     */
     ...
     * browser. For example: 1024x738.
     */
    public static final Dimension SCREEN_RESOLUTION = new Dimension("ga:screenResolution");

    /**
     * The sub-continent of site visitors, derived from IP addresses. For example, Polynesia or
     * Northern Europe.
     */
     ...
     * information, see Creating Custom Visitor Segments.
     */
    public static final Dimension USER_DEFINED_VALUE = new Dimension("ga:userDefinedValue");

    /**
     * A boolean indicating if visitors are new or returning. Possible values: New Visitor,
     * Returning Visitor.
     */
     ...
     * match. Note: Combining this dimension with ga:hour is not currently supported.
     */
     ...
     * have an ad group toys which you associate with the keywords fuzzy bear.
     */
     ...
     * advertising position might be side or top.
     */
    ...
    /**
     * The keywords used by visitors to reach your site, via both paid ads and through search
     * engine results.
     */
    ...
    /**
     * The domain (e.g. google.com) of the source referring the visitor to your website. The value
     * for this dimension sometimes contains a port address as well.
     */
    ...
    /** The title for the page, as specified in the <title></title> element of the HTML document. */
    ...
    /**
     * If you have categories enabled for internal site search, this field identifies the
     * categories used for the internal search. For example, you might have product categories for
     * internal search, such as electronics, furniture, or clothing.
     */
    ...
    public static final Dimension SEARCH_DESTINATION_PAGE = new Dimension(
     ...
     * search.
     */
    public static final Dimension SEARCH_KEYWORD_REFINEMENT = new Dimension(
     ...
     * occured or did not occur. Values are Visits With Site Search and Visits Without Site
     * Search.
     */
