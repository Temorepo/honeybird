sources = {u'Dimension': [(u'ga:browser',
                ...
                (u'ga:hour',
                 'A two digit hour of the day ranging from 00-23. (Google Analytics does not track visitor time more precisely than hours.) <strong>Note</strong>: Combining this dimension with {@link #AD_CONTENT} is not currently supported.'),
                (u'ga:javaEnabled',
                ...
                (u'ga:userDefinedValue',
                 'The value provided when you define custom visitor segments for your site. For more information, see <a href="http://code.google.com/apis/analytics/docs/tracking/gaTrackingVisitors.html#customVisitors">Creating Custom Visitor Segments</a>.'),
                (u'ga:visitorType',
                ...
                (u'ga:adContent',
                 'The first line of the text for your online Ad campaign. If you are using mad libs for your AdWords content, this field displays the keywords you provided for the mad libs keyword match. <strong>Note</strong>: Combining this dimension with {@link #HOUR} is not currently supported.'),
                (u'ga:adGroup',
                ...
                (u'ga:searchUsed',
                 'A boolean which separates visitor activity depending upon whether internal search activity occured or did not occur. Values are <code>Visits With Site Search</code> and <code>Visits Without Site Search</code>.')],
 u'Metric': [(u'ga:bounces',
             ...
             (u'ga:timeOnPage',
              'How long a visitor spent on a particular page or set of pages. Calculated by subtracting the initial view time for a particular page from the initial view time for a subsequent page. Thus, this metric does not apply to exit pages for your site. The value from this metric is returned in the XML as a string, with the value represented in total seconds. Different client libraries have various ways of representing this value, such as a double, float, long, or string.'),
             (u'ga:timeOnSite',
              'The total duration of visitor sessions over the selected dimension. For example, suppose you combine this field with a particular ad campaign. In this case, the metric will display the total duration of all visitor sessions for those visitors who came to your site via a particular ad campaign. You could then compare this metric to the duration of all visitors who came to your site through means other than the particular ad campaign. This would then give you a side-by-side comparison and a means to calculate the boost in visit duration provided by a particular campaign. The value from this metric is returned in the XML as a string, with the value represented in total seconds. Different client libraries have various ways of representing this value, such as a double, float, long, or string.'),
             (u'ga:visitors',
             ...
             (u'ga:visits',
              'The total number of visits over the selected dimension. A visit consists of a single-user session, which times out automatically after 30 minutes unless the visitor continues activity on your site, or unless you have adjusted the user session in the <code>ga.js</code> tracking for your site. See <a href="http://code.google.com/apis/analytics/docs/tracking/gaTrackingVisitors.html#userSession">Adjusting the User Session</a> for more information.'),
             (u'ga:adClicks',
             ...
             (u'ga:itemRevenue',
              'Total revenue from purchased product items on your site. See the tracking API reference for <a href="http://code.google.com/apis/analytics/docs/gaJS/gaJSApiEcommerce.html"><code>_addItem()</code></a> for additional information.'),
             (u'ga:itemQuantity',
             ...
             (u'ga:transactionRevenue',
              'The total sale revenue, including shipping and tax, if provided in the transation. See the documentation for <a href="http://code.google.com/apis/analytics/docs/gaJS/gaJSApiEcommerce.html#_gat.GA_Tracker_._addTrans"><code>_addTrans()</code></a> in the tracking API reference for additional information.'),
